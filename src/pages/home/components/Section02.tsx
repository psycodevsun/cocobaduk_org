    ...
    <Section id="section02" background="white" ariaLabelledby="section02-title" className='p-0'>
      <Container className='px-0 relative flex justify-center' size="wide">
        ...
        <div className='absolute top-[10%] max-md:px-7'>
          ...
          <div>
            <h1 className='font-bold text-3xl mt-3 text-center'>학생과 학부모가 <span className='text-[#2864a0]'>선택</span>한<br className='hidden max-md:block'/> 코코바둑</h1>
            <p className='text-center mt-2 text-sm'>장기간 검증된 집중력 • 사고력 중심 온라인 바둑 교육</p>
          </div>
        </div>
      </Container>
    </Section>
