...
export default function Hero() {
  return (
    <section id="home" className="relative h-[600px] text-gray-800 flex items-center overflow-hidden pt-16" style={{ backgroundColor: '#F8EEE2' }}>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center h-full">
          <div className="text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              <button className="bg-teal-500 hover:bg-teal-600 text-white px-8 py-4 rounded-lg font-bold text-lg transition-colors cursor-pointer whitespace-nowrap">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 text-teal-600">
                ...
                <span className="text-xl font-bold">010-6753-8985</span>
              </div>
            </div>
          </div>
