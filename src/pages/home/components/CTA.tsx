    ...
    <Section background="gray" ariaLabelledby="cta-title" className='bg-gradient-to-tr from-[#4493ce] to-[#2864a0] max-md:pt-10 pt-14 md:pb-10'>
      <Container>
        <div className="text-center">
          ...
          <p className='text-sm mb-3 tracking-tight text-white max-md:mt-3 max-md:text-base font-normal max-md:leading-[1.25]'>학습 목표와 현재 상황에 맞는<br className='hidden max-md:block'/> 개인별 맞춤 상담 제공</p>
          ...
          <Button variant="cta" size="large" asLink href={SITE_INFO.phone} className='font-normal flex items-center text-2xl text-center w-1/2 m-auto rounded-full justify-center bg-[#f23991] hover:bg-[#c9377c] max-md:w-full'>
            <a href='tel:010-6325-8985' className='font-bold'>체험수업 신청하기</a> 클릭 <Image src="/upimg/phone.png" alt='전화기 아이콘' className='w-[25px] h-[25px] ml-1'/>
          </Button>
        </div>
      </Container>
    </Section>
