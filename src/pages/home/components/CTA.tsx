...
const CTA = memo(function CTA() {
  return (
    <Section background="gray" ariaLabelledby="cta-title" className='bg-gradient-to-tr from-[#4493ce] to-[#2864a0] max-md:pt-10'>
      <Container>
        <div className="text-center">
          <h2 id="cta-title" className="text-3xl text-white md:text-4xl font-bold mb-2 tracking-title">
            온라인 바둑 교육의 새로운 기준
          </h2>
          <p className="text-xl lg:text-lg tracking-body mb-8 text-white max-md:mb-4">체험 수업으로 직접 확인하세요</p>
          ...
          <p className='text-xs mb-3 tracking-tight text-white max-md:mt-3 max-md:text-base max-md:tracking-tight max-md:leading-[1.25]'>학습 목표와 현재 상황에 맞는<br className='hidden max-md:block'/> 개인별 맞춤 상담 제공</p>
