      ...
      <Container>
          ...
          <div>
            <div className='border-[#104b85] border-[1px] rounded-3xl bg-white max-md:px-7'>
              ...
              <p className='text-center tracking-tight mb-14 max-md:text-xs max-md:mb-6 max-md:break-keep'>아이의 속도에 맞춰 매월 목표를 설정하고<br/>입문 → 초급 → 중급 → 고급  → 기사 → 유단자까지 <br className='hidden max-md:block'/>성장 방향을 함께 공유합니다</p>
            </div>
          </div>
          ...
          <div className='mt-32 max-md:mt-12'>
            <div className='border-[#104b85] border-[1px] rounded-3xl bg-white max-md:px-7'>
              ...
              <p className='text-center mb-8 tracking-tight max-md:text-sm max-md:mb-6 max-md:break-keep'>바둑 실력만 키우는 수업이 아닙니다<br/>바둑을 통해 아이의 성향과 심리를 이해하고 <br className='hidden max-md:block'/>학습태도•행동까지 함께 지도합니다</p>
            </div>
          </div>
          ...
          <div className='mt-10 relative'>
            ...
            <div className='border-[#104b85] border-[1px] rounded-3xl bg-white relative b-[100px] bottom-24 z-10 max-md:px-7 max-md:bottom-8'>
              ...
              <p className='text-center mt-8 mb-10 max-md:text-sm max-md:mb-6 max-md:break-keep tracking-tight'>아이의 작은 변화까지 놓치지 않는 초밀착 지도<br/>단체수업에서는 불가능한 개별 맞춤 케어로 <br className='hidden max-md:block'/>성장 속도를 높입니다</p>
            </div>
          </div>
          ...
          <div className='mt-2'>
            <div className='border-[#104b85] border-[1px] rounded-3xl bg-white max-md:px-7'>
              ...
              <div className='flex justify-center items-center gap-12 my-2 max-md:my-4'>
                <Image src='/upimg/sec1-4.png' className='w-auto' alt='커리큘럼'/>
              </div>

              <p className='text-center mb-8 tracking-tight max-md:text-sm max-md:mb-6 max-md:break-keep'>23년 경력으로 만든 '우리 아이 맞춤' 커리큘럼<br/>모든 아이에게 같은 수업은 없습니다 아이의 속도에 맞춰 매월 교육 목표를 단계별로 설계합니다</p>
            </div>
          </div>
      </Container>
    </Section>
