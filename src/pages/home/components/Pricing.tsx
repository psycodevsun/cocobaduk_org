    ...
    <section id="pricing" className="py-20" style={{ backgroundColor: '#F8EEE2' }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
          <div className="bg-white border-2 border-teal-200 p-8 rounded-xl shadow-lg">
            <div className="flex items-center justify-center mb-6">
              ...
              <div className="text-center">
                <h3 className="text-2xl font-bold text-teal-800">체험수업 (1시간)</h3>
            ...
            <div className="text-center">
              ...
              <a href="tel:010-6753-8985" className="inline-block bg-teal-500 hover:bg-teal-600 text-white px-8 py-4 rounded-lg font-bold text-lg transition-colors cursor-pointer whitespace-nowrap">
