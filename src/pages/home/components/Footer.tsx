        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="flex flex-col justify-center h-full">
            <div className="mb-8">
              ...
              <p className="text-lg text-white tracking-tight">우리 아이를 위한 최고의 선택!</p>
            ...
            <div className="px-6 py-5 bg-white rounded-xl">
              <h4 className="text-xl text-pt-b300 font-bold tracking-tight">지금 바로 전화 주세요</h4>
              <a
                href={SITE_INFO.phone}
                className="flex items-center text-3xl text-pt-b200 font-bold tracking-tight"
