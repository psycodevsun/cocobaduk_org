    ...
    <Section background="warm" ariaLabelledby="testimonials-title" className='bg-[#f7eee3] pb-0 max-md:pt-14'>
      <Container size='wide' className='p-0 relative'>
        ...
        <div className='text-center'>
          ...
          <p className='bg-primary-emphasis text-white text-2xl w-fit px-8 py-1 m-auto mb-6 rounded-full font-black mt-2 max-md:w-fit max-md:px-4'>집에서 경험하고 싶은 분</p>
        </div>
        ...
        <div className="text-center absolute bottom-[50px] w-full flex justify-center max-md:bottom-[50px] max-mb:relative">
          <div className="bg-primary-emphasis text-white p-8 py-12 max-md:p-4 rounded-2xl w-[900px] max-md:w-[90%]">
            <div className="">
            ...
            <div className="text-center">
              <span className="inline-block px-14 py-1 rounded-full bg-surface-warm">
                <p className="text-3xl font-bold text-pt-b300 max-md:py-1 max-md:text-xl tracking-tight max-md:leading-[1.1]">
